      ...
      <section className="pt-14 xl:pt-[140px]">
        <MaxWidthWrapper>
          <div className="flex flex-col gap-y-3 text-center lg:gap-y-5 xl:text-left">
            <h1 className="font-inter text-[28px] font-semibold text-brand-main sm:text-[33px] md:text-[54px] lg:text-[72px] lg:leading-[87px]">
              Эмоции вместо вещей
            </h1>
            <h2 className="font-inter text-xs font-semibold text-brand-main md:text-lg lg:text-[36px] lg:leading-[44px]">
              Подарите вашему близкому человеку яркие эмоции
            </h2>
            <p className="font-inter text-xs font-normal md:text-lg lg:text-2xl lg:leading-[29px]">
